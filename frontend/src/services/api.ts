...
export const getDashboardOverview = async (params?: { region?: string; category?: string; customer?: string; start_date?: string; end_date?: string }): Promise<DashboardOverview> => (await api.get("/dashboard/overview", { params })).data;
