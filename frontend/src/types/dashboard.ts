...
export interface DashboardOverview { data_mode: string; kpis: KpiMetric[]; revenue_trend: TrendPoint[]; revenue_by_region: BreakdownItem[]; revenue_by_category: BreakdownItem[]; top_customers: BreakdownItem[]; top_products: BreakdownItem[]; generated_at: string }
